...
const zh = {
    ...
    'template.toast.req_params': '请填写必填参数',
    'template.toast.gw_down': '⚠️ Gateway 未启动，任务将无法派发！',
    'template.confirm.gw_down': 'Gateway 未启动，继续？',
    'template.confirm.issue': '确认下旨？\\n\\n{snippet}',
    'template.toast.issued': '📜 {taskId} 旨意已下达',
    'template.error.issue_failed': '下旨失败',
    'template.toast.srv_err': '⚠️ 服务器连接失败',
    'template.button.issue': '下旨',
    'template.label.template': '圣旨模板',
    'template.preview.title': '📜 将发送给{org}的旨意：',
    'template.button.preview': '👁 预览旨意',
    'template.button.submit': '📜 下旨',

    'template.cat.daily_office': '日常办公',
    'template.cat.data_analysis': '数据分析',
    'template.cat.engineering': '工程开发',
    'template.cat.content': '内容创作',

    'template.tpl.tpl-weekly-report.name': '周报生成',
    'template.tpl.tpl-weekly-report.desc': '基于本周看板数据和各部产出，自动生成结构化周报',
    'template.tpl.tpl-weekly-report.param.date_range': '报告周期',
    'template.tpl.tpl-weekly-report.param.focus': '重点关注（逗号分隔）',
    'template.tpl.tpl-weekly-report.param.format': '输出格式',
    'template.tpl.tpl-weekly-report.param.format.opt.Markdown': 'Markdown',
    'template.tpl.tpl-weekly-report.param.format.opt.飞书文档': '飞书文档',

    'template.tpl.tpl-code-review.name': '代码审查',
    'template.tpl.tpl-code-review.desc': '对指定代码仓库/文件进行质量审查，输出问题清单和改进建议',
    'template.tpl.tpl-code-review.param.repo': '仓库/文件路径',
    'template.tpl.tpl-code-review.param.scope': '审查范围',
    'template.tpl.tpl-code-review.param.scope.opt.全量': '全量',
    'template.tpl.tpl-code-review.param.scope.opt.增量(最近commit)': '增量(最近commit)',
    'template.tpl.tpl-code-review.param.scope.opt.指定文件': '指定文件',
    'template.tpl.tpl-code-review.param.focus': '重点关注（可选）',

    'template.tpl.tpl-api-design.name': 'API 设计与实现',
    'template.tpl.tpl-api-design.desc': '从需求描述到 RESTful API 设计、实现、测试一条龙',
    'template.tpl.tpl-api-design.param.requirement': '需求描述',
    'template.tpl.tpl-api-design.param.tech': '技术栈',
    'template.tpl.tpl-api-design.param.auth': '鉴权方式',
    'template.tpl.tpl-api-design.param.auth.opt.无': '无',

    'template.tpl.tpl-competitor.name': '竞品分析',
    'template.tpl.tpl-competitor.desc': '爬取竞品网站数据，分析对比，生成结构化报告',
    'template.tpl.tpl-competitor.param.targets': '竞品名称/URL（每行一个）',
    'template.tpl.tpl-competitor.param.dimensions': '分析维度',
    'template.tpl.tpl-competitor.param.format': '输出格式',
    'template.tpl.tpl-competitor.param.format.opt.Markdown报告': 'Markdown报告',
    'template.tpl.tpl-competitor.param.format.opt.表格对比': '表格对比',

    'template.tpl.tpl-data-report.name': '数据报告',
    'template.tpl.tpl-data-report.desc': '对给定数据集进行清洗、分析、可视化，输出分析报告',
    'template.tpl.tpl-data-report.param.data_source': '数据源描述/路径',
    'template.tpl.tpl-data-report.param.questions': '分析问题（每行一个）',
    'template.tpl.tpl-data-report.param.viz': '是否需要可视化图表',
    'template.tpl.tpl-data-report.param.viz.opt.是': '是',
    'template.tpl.tpl-data-report.param.viz.opt.否': '否',

    'template.tpl.tpl-blog.name': '博客文章',
    'template.tpl.tpl-blog.desc': '给定主题和要求，生成高质量博客文章',
    'template.tpl.tpl-blog.param.topic': '文章主题',
    'template.tpl.tpl-blog.param.audience': '目标读者',
    'template.tpl.tpl-blog.param.length': '期望字数',
    'template.tpl.tpl-blog.param.length.opt.~1000字': '~1000字',
    'template.tpl.tpl-blog.param.length.opt.~2000字': '~2000字',
    'template.tpl.tpl-blog.param.length.opt.~3000字': '~3000字',
    'template.tpl.tpl-blog.param.style': '风格',
    'template.tpl.tpl-blog.param.style.opt.技术教程': '技术教程',
    'template.tpl.tpl-blog.param.style.opt.观点评论': '观点评论',
    'template.tpl.tpl-blog.param.style.opt.案例分析': '案例分析',

    'template.tpl.tpl-deploy.name': '部署方案',
    'template.tpl.tpl-deploy.desc': '生成完整的部署检查单、Docker配置、CI/CD流程',
    'template.tpl.tpl-deploy.param.project': '项目名称/描述',
    'template.tpl.tpl-deploy.param.env': '部署环境',
    'template.tpl.tpl-deploy.param.ci': 'CI/CD 工具',
    'template.tpl.tpl-deploy.param.ci.opt.无': '无',

    'template.tpl.tpl-email.name': '邮件/通知文案',
    'template.tpl.tpl-email.desc': '根据场景和目的，生成专业邮件或通知文案',
    'template.tpl.tpl-email.param.scenario': '使用场景',
    'template.tpl.tpl-email.param.scenario.opt.商务邮件': '商务邮件',
    'template.tpl.tpl-email.param.scenario.opt.产品发布': '产品发布',
    'template.tpl.tpl-email.param.scenario.opt.客户通知': '客户通知',
    'template.tpl.tpl-email.param.scenario.opt.内部公告': '内部公告',
    'template.tpl.tpl-email.param.purpose': '目的/内容',
    'template.tpl.tpl-email.param.tone': '语调',
    'template.tpl.tpl-email.param.tone.opt.正式': '正式',
    'template.tpl.tpl-email.param.tone.opt.友好': '友好',
    'template.tpl.tpl-email.param.tone.opt.简洁': '简洁',

    'template.tpl.tpl-standup.name': '每日站会摘要',
    'template.tpl.tpl-standup.desc': '汇总各部今日进展和明日计划，生成站会摘要',
    'template.tpl.tpl-standup.param.range': '汇总范围',
